...
/**
 * Created by Harshit on 20-01-2017.
 */
...
public class ActivityViewEmployee extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.content_activity_view_employee);
    ...
    private void getEmployee(){
        class GetEmployee extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(ActivityViewEmployee.this,"Fetching...","Wait...",false,false);
            }
    ...
    private void updateEmployee(){
        ...
        class UpdateEmployee extends AsyncTask<Void,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(ActivityViewEmployee.this,"Updating...","Wait...",false,false);
            }
            ...
            protected void onPostExecute(String s) {
                super.onPostExecute(s);
                loading.dismiss();
                Toast.makeText(ActivityViewEmployee.this,s,Toast.LENGTH_LONG).show();
            }
        ...
        alertDialogBuilder.setPositiveButton("Yes",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        deleteEmployee();
                        startActivity(new Intent(ActivityViewEmployee.this,ViewAllEmployee.class));
                    }
                });
